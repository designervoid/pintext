...
const state = {
  hintsObjectUser: [{
      ...
      pin: 'USER - gaming',
      counter: 0,
      title: 'USER - another some title about gaming',
    ...
    {
      id: 5,
      pin: 'USER - programming',
      counter: 0,
      title: 'USER - some title about prograaming',
      text: 'USER - some text here about prograaming',
    ...
    },
    {
      ...
      pin: 'USER - computers',
      counter: 0,
      title: 'USER - some title about computers',
      text: 'USER - some text here about computers',
